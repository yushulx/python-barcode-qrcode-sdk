...
image = cv2.imread('images/normal.jpg')
...
detect('Grayscale', grayscale_image_copy,
...
print(ret)
binary_image_copy = thresh.copy()
print('--------------------------------------------------------------')

detect('B&W', binary_image_copy, EnumImagePixelFormat.IPF_GRAYSCALED)
print('--------------------------------------------------------------')
