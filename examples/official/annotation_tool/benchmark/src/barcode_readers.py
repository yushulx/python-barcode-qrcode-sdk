...
class DynamsoftBarcodeReader(BarcodeReaderInterface):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._template_name = None  # custom template name; None = use PT_READ_BARCODES default
    ...
    def decode_barcodes(self, image_path: str) -> Tuple[List[Dict[str, Any]], float]:
        ...
        try:
            ...
            # Capture barcodes
            from dynamsoft_capture_vision_bundle import EnumPresetTemplate as EPT
            template = self._template_name if self._template_name else EPT.PT_READ_BARCODES.value
