...
DEFAULT_TEMPLATE_FILES = [
    SKILL_DIR / "templates" / "examples" / "dbr_template.json",
]
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to the bundled template-optimizer example template if present."
        ),
    )
    parser.add_argument(
        "--template-name",
...
def resolve_template_files(cli_template_files):
    ...
    paths = []
    for candidate in DEFAULT_TEMPLATE_FILES:
