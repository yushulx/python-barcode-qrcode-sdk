...
if sys.platform == "linux" or sys.platform == "linux2":
    ...
    # Windows
    dbr_lib_name = 'DBRx64'
    dbr_lib_dir = r'c:\Program Files (x86)\Dynamsoft\Barcode Reader 6.5.2\Components\C_C++\Lib'
    dbr_dll = r'c:\Program Files (x86)\Dynamsoft\Barcode Reader 6.5.2\Components\C_C++\Redist\x64'
